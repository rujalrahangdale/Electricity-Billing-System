...
public class UpdateInfromation extends JFrame implements ActionListener{

    JTextField tfaddress, tfstate, tfcity, tfemail, tfphone;
    JButton update, cancel;
    String meter;
    JLabel name;
    UpdateInfromation(String meter) {
        this.meter = meter;
        ...
        try {
            ...
            while(rs.next()) {
                ...
                meternumber.setText(rs.getString("mete_no"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                conn c = new conn();
                c.s.executeUpdate("update customer set address = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phone = '"+phone+"' where mete_no = '"+meter+"'");
